    ...
    () =>
      StyleSheet.create({
        ...
        filterOptionButton: {
          ...
          paddingHorizontal: deviceType === "tv" ? spacing * 1.25 : spacing,
          paddingVertical: deviceType === "tv" ? spacing / 1.5 : spacing / 2.25,
          minHeight: deviceType === "tv" ? 52 : undefined,
          minWidth: deviceType === "tv" ? 132 : undefined,
