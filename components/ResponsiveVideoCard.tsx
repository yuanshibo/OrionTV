...
const ResponsiveVideoCard = forwardRef<View, VideoCardProps>(
  (
    ...
    const styles = useMemo(() => createStyles(responsiveConfig, colors), [responsiveConfig, colors]);
              ...
              <View style={styles.overlay}>
                {isContinueWatching && (
                  <View style={styles.continueWatchingBadge}>
                    <Play size={responsiveConfig.deviceType === 'tv' ? 16 : 12} color={colors.text} fill={colors.text} />
...
const createStyles = (responsiveConfig: ResponsiveConfig, colors: (typeof Colors.dark) | (typeof Colors.light)) => StyleSheet.create({
  wrapper: {
